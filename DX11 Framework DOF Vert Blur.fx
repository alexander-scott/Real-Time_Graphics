...
float4 PS(VS_OUTPUT input) : SV_Target
{
	...
	float depth = txDepth.Sample(samClamp, input.Tex).r;

	if ((depth < 0.07f || depth > 0.2f))
	{
		float texelSize = 1.0f / 1080;
		//return float4(0.0f, 0.5f, 0.0f, 1.0f);

		float2 Tex1 = input.Tex + float2(0.0f, texelSize * -4.0f);
		float2 Tex2 = input.Tex + float2(0.0f, texelSize * -3.0f);
		float2 Tex3 = input.Tex + float2(0.0f, texelSize * -2.0f);
		float2 Tex4 = input.Tex + float2(0.0f, texelSize * -1.0f);
		float2 Tex5 = input.Tex + float2(0.0f, texelSize *  0.0f);
		float2 Tex6 = input.Tex + float2(0.0f, texelSize *  1.0f);
		float2 Tex7 = input.Tex + float2(0.0f, texelSize *  2.0f);
		float2 Tex8 = input.Tex + float2(0.0f, texelSize *  3.0f);
		float2 Tex9 = input.Tex + float2(0.0f, texelSize *  4.0f);

		float weight0 = 1.0f;
		float weight1 = 0.9f * 10.0f;
		float weight2 = 0.55f * 10.0f;
		float weight3 = 0.18f * 10.0f;
		float weight4 = 0.1f * 10.0f;
